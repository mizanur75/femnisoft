@extends('layouts.app')
@section('title','All Orders '.$supplier->name)
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="row">
			...
			<a href="{{route('pharmacy.purchase.index')}}" class="brn btn-sm btn-primary float-right btn-padding"><i class="fa fa-list"></i> All Invoice</a>
			</div>
		</div>	
				...
				<table id="tableId" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{route('pharmacy.supplierinvoicedetails',\Crypt::encrypt($order->id))}}" class="btn btn-padding btn-sm btn-info"><i class="fa fa-eye"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
