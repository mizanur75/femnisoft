	...
	<div class="col-md-12">
	    <div class="widget-area-2 proclinic-box-shadow color-red">
	    	...
	    	@php($nit_profit = $totalamount - $tcosts)
	    		...
	    		<form action="{{ route('pharmacy.diffDate') }}" method="GET">
	    			<div class="row mb-4" style="padding: 10px;">
			        	<div class="col-md-4">
			    			<div class="card border-primary mx-sm-1 p-3 blue">
			    				<input type="text" class="form-control form-control-sm" name="start" id="start" placeholder="Enter Start Date" autocomplete="off">
				            </div>
				        </div>
				        <div class="col-md-4">
				            <div class="card border-primary mx-sm-1 p-3 blue">
			    				<input type="text" class="form-control form-control-sm" name="finish" id="finish" placeholder="Enter Finished Date" autocomplete="off">
				            </div>
				        </div>
				        <div class="col-md-4">
				            <div class="card border-primary mx-sm-1 p-3 blue">
			...
			<div class="row p-2 mb-4">
		        <div class="col-md-3 mb-4">
		            <div class="card border-primary mx-sm-1 p-3 blue">
		                <div class="card border-primary shadow text-primary p-3 my-card" ><i class="fa fa-file"></i></div>
