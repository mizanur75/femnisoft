...
<div class="row">
    <div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow pb-3" id="printarea">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="proclinic-text-color">{{$order->cname == !null ? $order->cname: 'XXXXXXX'}}</h3>
                    <span>Phone: {{$order->phone}}</span>
                    <br>

                    <span>Address: {{$order->caddress == !null ? $order->caddress: 'XXXXXXX'}}</span>
                </div>
                <div class="col-sm-6 text-md-right">
                    <h3>INVOICE</h3>
                    <span>Invoice # O-INV-{{$order->id}}</span>
                    <br>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="border p-2">
                        <strong>Note:</strong> This is Computer Generated Invoice. Generated by  {{Auth::user()->name}}. <strong>Developed and Maintainance By Mizanur Rahman</strong><br>
