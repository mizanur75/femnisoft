...
<div class="row">
	...
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			<form action="{{route('pharmacy.profile.store')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						...
						<input type="text" name="tax" class="form-control form-control-sm" id="tax" placeholder="Enter Tax Rate(%)">
					</div>
					<div class="form-group col-md-3">
						<label for="discount">Discount (%)</label>
						<input type="text" name="discount" class="form-control form-control-sm" id="discount" placeholder="Enter Discount (%)">
					</div>
					<div class="form-group col-md-3">
