...
<div class="row">
    <div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow text-right">
            @if($doctor->status == 1)
            <button type="button" class="btn btn-padding btn-success mb-3"><i class="fa fa-check-circle-o"></i> Active</button>
            @else
            <button type="button" class="btn btn-padding btn-danger mb-3"><i class="fa fa-close"></i> Busy</button>
            @endif
        </div>
    </div>
