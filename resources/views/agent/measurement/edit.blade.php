...
<div class="row">
	...
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			@endforeach
			@endif
			<form action="{{route('agent.measurement.update', $measurement->id)}}" method="POST">
				@csrf
				@method('PUT')
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" name="measurement" class="form-control form-control-sm" placeholder="Type Name" value="{{$measurement->measurement}}">
					</div>
