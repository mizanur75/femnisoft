...
<div class="row">
	<div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow text-right" style="padding: 12px 18px 7px 0px;">
				...
				<table id="tableId" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{route('agent.measurement.edit',$measurement->id)}}" class="btn btn-padding btn-sm btn-primary"><i class="fa fa-edit"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Measurement Info</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action=" {{ route('agent.measurement.store') }}" method="POST">
	      @csrf
	      <div class="modal-body">
	      	<label for="">Measurement</label>
	      	<input type="text" name="measurement" class="form-control form-control-sm" placeholder="Input Measurement">
	      	<div for="">Status</div>
