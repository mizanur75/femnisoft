...
<div class="row">
	<div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow text-right" style="padding: 5px 18px 0px 0px;">
			...
			<a href="{{route('agent.medicine.create')}}" class="btn btn-padding btn-sm btn-primary">
				...
				<table id="tableId" class="table table-sm table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="{{route('agent.medicine.edit',$medicine->id)}}" class="btn btn-padding btn-sm btn-primary"><i class="fa fa-edit"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action=" {{ route('agent.medicine.store') }}" method="POST">
	      @csrf
