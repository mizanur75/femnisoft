...
<div class="row">
	...
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			@endforeach
			@endif
			<form action="{{route('agent.medicine.store')}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="name" placeholder="Enter Medicine Name" class="w-100 form-control-sm">
					</div>
					<div class="form-group col-md-4">
						<label for="dob">Brand Name</label>
						<input type="text" name="brand_name" placeholder="Enter Brand Name" class="w-100 form-control-sm">
					</div>
					<div class="form-group col-md-4">
						<label for="dob">Disease Name</label>
						<input type="text" name="disease" placeholder="Enter Disease Name" class="w-100 form-control-sm">
					</div>
					<div class="form-group col-md-4">
						<label for="dob">Company Name</label> <span class="text-danger">*</span>
						<input type="text" name="company" placeholder="Enter Company Name" class="w-100 form-control-sm">
					</div>
					<div class="form-group col-md-12">
						<label for="phone">Description</label>
						<textarea type="text" name="description" placeholder="Enter Medicine Description" class="w-100 form-control-sm"></textarea>
					</div>
					<div class="form-group col-md-12">
						<label for="phone">Side Effect</label>
						<textarea type="text" name="side_effect" placeholder="Enter Medicine Side Effect" class="w-100 form-control-sm"></textarea>
					</div>
					<div class="form-group col-md-12">
						<label for="phone">Doses</label>
						<textarea type="text" name="doses" placeholder="Enter Medicine Doses" class="w-100 form-control-sm"></textarea>
					</div>
