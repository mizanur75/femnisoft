@extends('layouts.app')
@section('title','Follow-up Invoice')
	...
	<div class="col-md-12 pt-3">
		<form action="{{$auth == 'Agent' ? route('agent.invoice.store') : route('doctor.invoice.store')}}" method="POST" enctype="multipart/form-data">
			...
			<div class="col-md-12 table-responsive">
				<div class="row">
					<div class="col-md-3">
						<label for="ecoh_id" class="font-weight-bold col-md-4"> ECOH ID</label>
			...
			$.ajax({
				...
				success: function(test){
					...
					var newRow = '<tr>'+
                                        ...
                                        '</td>'+
                                        '<td>'+
                                            '<input type="number" name="discount[]" class="form-control form-control-sm discount text-right" value="0" />'+
                                        '</td>'+
                                        '<td>'+
