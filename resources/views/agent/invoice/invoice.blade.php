...
<div class="row">
	<div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow text-right pt-2">
            <!-- <a href="{{route('agent.invoice.edit',\Crypt::encrypt($invoice_master->id))}}" class="btn btn-padding btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a> -->
		...
		<div class="widget-area-2 proclinic-box-shadow pb-2">
			...
			<div class="row ">
				...
				<div class="col-sm-6 text-md-right mb-2 color-black">
					...
					<span>{{$invoice_master->patient->name}} - {{$invoice_master->patient->centre_patient_id}}</span>
				</div>
			</div>
			<!-- /Invoice Head -->
			<!-- Invoice Content -->
