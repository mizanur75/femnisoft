                    ...
                    <table id="tableId" class="table table-sm table-bordered table-striped">
                        ...
                        @foreach($paid_amount as $amount)
                            <tr class="text-center">
                                ...
                                <td>
                                    @if($amount->status == 0)
                                        <a href="{{route('admin.receivedpayment',$amount->id)}}" onclick="return confirm('Are you sure!')" class="btn btn-padding btn-sm btn-danger">Confirm</a>
                                    @else
                                        <button type="button" onclick="return confirm('Payment Received')" class="btn btn-padding btn-sm btn-primary">Received</button>
                                    @endif
                                </td>
                                <td>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.storepayment')}}" method="post">
                    @csrf
