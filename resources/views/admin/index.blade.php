...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-blue">
            ...
            <div class="widget-right">
                ...
                <span class="numeric">{{$appoints->count()}}</span>
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-green">
            ...
            <div class="widget-right">
                <h4 class="wiget-title">Pharmacies</h4>
                <span class="numeric">{{$pharmacies->count()}}</span>
                <p class="inc-dec mb-0"><span class="ti-angle-up"></span> +20% Increased</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-yellow">
            ...
            <div class="widget-right">
                ...
                <span class="numeric">{{$doctors->count()}}</span>
                <p class="inc-dec mb-0"><span class="ti-angle-up"></span> +20% Increased</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-green">
            ...
            <div class="widget-right">
                ...
                <span class="numeric">{{$patients->count()}}</span>
                <p class="inc-dec mb-0"><span class="ti-angle-up"></span> +20% Increased</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-yellow">
            ...
            <div class="widget-right">
                ...
                <span class="numeric">{{$prescriptions->count()}}</span>
                <p class="inc-dec mb-0"><span class="ti-angle-up"></span> +10% Increased</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="widget-area proclinic-box-shadow color-green">
            ...
            <div class="widget-right">
                <h4 class="wiget-title">Medicines</h4>
                <span class="numeric">{{$medicines->count()}}</span>
                <p class="inc-dec mb-0"><span class="ti-angle-up"></span> +20% Increased</p>
            </div>
        </div>
    </div>
