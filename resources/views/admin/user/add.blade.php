			...
			<form action="{{route('admin.user.store')}}" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" name="username" placeholder="Age" class="form-control form-control-sm" id="age">
					</div>
					<div class="form-group col-md-6">
					...
					<div class="form-group col-md-3">
						...
						<input type="number" name="amount" placeholder="Enter Monthly Installment Amount" class="form-control form-control-sm" id="amount">
					</div>
					<div class="form-group col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<input type="file" name="logo" class="form-control form-control-sm" id="file">
					</div>
