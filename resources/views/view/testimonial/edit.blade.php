...
<div class="row">
	...
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			@endforeach
			@endif
			<form action="{{route('doctor.web-testimonial.update', $testimonial->id)}}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('PUT')
				<div class="form-row">
							...
							<div class="form-group col-md-10" id="webcamImage">
								<div class="row">
									<div class="form-group col-md-5">
		    							...
		    							<img src="{{asset('assets/images/testimonials/'.$testimonial->photo)}}" height="200" width="240" alt="" id="photo">
									</div>
								</div>
							</div>
						</div>
