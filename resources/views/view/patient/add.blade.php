					...
					<div class="form-group col-md-6">
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<input type="text" name="phone" placeholder="Phone" class="form-control form-control-sm" id="phone" minlength="11" maxlength="11" required>
							</div>
							<div class="form-group col-md-12">
	...
	$(function(){
		$("#address_id").autocomplete({
			source: function(request, response){
				$.ajax({
					url: '{{$auth == "Agent" ? route("agent.loadAddress") : route("doctor.loadAddress")}}',
					type: 'POST',
					dataType: 'JSON',
