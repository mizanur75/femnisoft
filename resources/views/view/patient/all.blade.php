        ...
        <div class="widget-area-2 proclinic-box-shadow text-right pt-2">
        	<div class="row">
        		<div class="col-md-11" style="margin-right: -15px;">
        			<form action="{{$auth == 'Agent' ? route('agent.barcode_details') : route('agent.barcode_details')}}" method="POST">
        				@csrf
        		...
        		<div class="col-md-1 mt-2">
		            <a href="{{$auth == 'Agent' ? route('agent.patient.create') : route('doctor.patient.create')}}" class="btn btn-padding btn-sm btn-success"><i class="fa fa-plus"></i> Add New</a>
		        </div>
        	</div>
        </div>
    </div>
	...
	<div class="col-md-12">
        ...
        @endif
			<div class="table-responsive">
					...
					<div class="row mb-2">
						<div class="col-md-3">
							<form action="{{route('agent.patient.index')}}" method="GET">
						...
						<div class="col-md-9">
							<form action="{{route('agent.patient_search')}}" method="GET">
				...
				<table id="tableId" class="table table-sm table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<!-- <td>Status</td> -->
							<td class="text-center">
								<a href="{{route('agent.patient.show',\Crypt::encrypt($patient->id))}}" class="btn btn-padding btn-sm btn-info" target="_blank"><i class="fa fa-eye"></i></a>
        						<a href="{{route('agent.patient.edit',\Crypt::encrypt($patient->id))}}" class="btn btn-padding btn-sm btn-primary"><i class="fa fa-edit"></i>
        						</a>
							</td>
						</tr>
						@endforeach
