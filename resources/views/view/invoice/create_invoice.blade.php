			...
			<div class="col-md-12 table-responsive">
				...
				<table class="table table-sm table-bordered">
					...
					<tbody id="addRow">
						...
						@php($test_details = \App\Model\Test::where('test_name',$test)->first())
							<tr>
	                            <td class="text-center">
	                                <input type="hidden" name="test_id[]" class="id" value="{{$test_details->id}}"/>{{$loop->index +1}}</td>
	                            <td>{{$test_details->test_name}}</td>
	                            <td class="text-right">
	                                <input type="text" name="unitcost[]" class="form-control form-control-sm unitcost" value="{{$test_details->cost}}" readonly />
	                            </td>
	                            <td class="text-right">
