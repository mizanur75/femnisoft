...
<div class="row">
	...
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			@endforeach
			@endif
			<form action="{{route('doctor.web-category.update',$category->id)}}" method="POST">
				@csrf
				@method('PUT')
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" name="name" class="form-control form-control-sm" placeholder="Type Name" value="{{$category->name}}">
					</div>
			      	
			        <div class="form-check form-check-inline">
			          <input class="form-check-input" type="radio" name="status" id="inlineRadio1" value="1" {{$category->status == 1 ? 'checked':''}}>
