...
<div class="row">
	...
	<div class="col-md-12">
        <div class="widget-area-2 proclinic-box-shadow text-right pt-2">
            <a href="{{route('doctor.web-blog.index')}}" class="btn btn-padding btn-sm btn-success"><i class="fa fa-list"></i> All Blogs</a>
        </div>
    </div>
	<!-- Widget Item -->
	<div class="col-md-12">
		<div class="widget-area-2 proclinic-box-shadow">
			...
			@endforeach
			@endif
			<form action="{{route('doctor.web-blog.update', $blog->id)}}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('PUT')
				<div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="description" id="nic-edit" class="form-control" cols="10" rows="3">{!! $blog->description !!}</textarea>
                    </div>
					...
					<div class="form-check col-md-6 mb-2">
						<div class="text-left">
							<div class="custom-control custom-checkbox">
								<input class="custom-control-input" type="checkbox" id="ex-check-2" name="status" value="1"  required {{$blog->status == 1 ? 'checked':''}}>
